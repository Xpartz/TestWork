    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 frag(v2f i) : SV_Target
            {
                ...
                float4 baseMap = SAMPLE_TEXTURE2D(_BaseMap, sampler_BaseMap, i.uvBase);
                ...
                float3 diffuse = baseMap.rgb * _BaseColor.rgb * shadowNL * attenuatedLightColor;

                float3 specular = _SpecularColor.rgb * specularNH * attenuatedLightColor;
                float3 rimLight = rim * _RimColor.rgb * baseMap.rgb * _BaseColor.rgb;
                float3 ambient = bakedGI * _BaseColor.rgb * baseMap.rgb + rimLight;
                ...
                for (int e = 0; e < additionalLightsCount; ++e)
                {
                    ...
                    float3 addDiffuse = baseMap.rgb * _BaseColor.rgb * diffuseTerm * light.color;
